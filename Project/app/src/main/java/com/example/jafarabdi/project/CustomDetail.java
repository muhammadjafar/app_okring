...
public class CustomDetail extends ArrayAdapter<String>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageLoader.get("http://192.168.42.44/Android/includes/upload/"+image[position], ImageLoader.getImageListener(imageView, R.mipmap.ic_launcher, android.R.drawable.ic_dialog_alert));

        imageView.setImageUrl("http://192.168.42.44/Android/includes/upload/"+image[position], imageLoader);
